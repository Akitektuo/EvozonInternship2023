...
{
    public class AddSuggestedMenuRequest
    {
        public string Name { get; set; }
        public string Description { get; set; }
        public MenuCategory CategoryId { get; set; }

        public List<AddSuggestedMealRequest> Meals { get; set; }
    }

    public class AddSuggestedMenuRequestValidator : AbstractValidator<AddSuggestedMenuRequest>
    {
        public AddSuggestedMenuRequestValidator()
        {
            RuleFor(x => x.Name)
                .NotEmpty()
                .MinimumLength(2)
            ...
            RuleFor(x => x.Meals)
                ...
                .Must(mealList => mealList.DistinctBy(m => m.Recipe.Name).Count() == mealList.Count)
